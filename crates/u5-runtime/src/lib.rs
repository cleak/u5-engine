...
pub use tlk_control_codes::{
    ...
    TLK_DOUBLE_QUOTE_ENCODED, TLK_EMPTY_INPUT_BYE_MESSAGE, TLK_GENERIC_SIGNAL_COUNT,
    TLK_GOLD_PAYMENT_ARGUMENT_BYTES, TLK_HEADER_ENTRY_LEN, TLK_HEADER_FIXED_READ,
    ...
    TLK_ONE_BYTE_INTRODUCER_ARGUMENT_BYTES, TLK_PRINTABLE_TEXT_FIRST, TLK_PRINTABLE_TEXT_LAST,
    TLK_SENTINEL_NPC_ID, TLK_TEXT_XOR_MASK, TOWNE_TLK_NPCS, TalkRefusal, TlkActionDispatchVerb,
