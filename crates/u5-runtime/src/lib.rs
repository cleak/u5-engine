...
pub use commands::{
    ...
    REST_WATCH_YES_LITERAL, SELECTION_CANCELLED_LITERAL, TOWN_CANNON_TILE_FIRST,
    ...
    WISHING_WELL_WISH_MAX_CHARS, WishingWellWish, XIT_ON_FOOT_REFUSAL, YELL_INPUT_MAX_LEN,
    YELL_NO_EFFECT_MESSAGE, YELL_NOTHING_SAID_MESSAGE, YELL_SAILS_FURLED_MESSAGE,
