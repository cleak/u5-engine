...
pub use commands::{
    ...
    USE_ITEM_ECHO_WATCH, USE_MAGIC_CARPET_BOARDED, USE_MAGIC_CARPET_XIT_FIRST,
    USE_NO_USABLE_ITEMS_REFUSAL, USE_PLANS_RIGGED_LINE, USE_PLANS_SHIPBOARD_ONLY_REFUSAL,
    USE_POCKET_WATCH_PREFIX, USE_POTION_TARGET_PROMPT, USE_REGALIA_REMOVED, USE_SCEPTRE_WIELDED,
