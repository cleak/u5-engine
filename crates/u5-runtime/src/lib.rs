...
pub use intro::{
    ...
    TITLE_LOWER_BAND_CLEAR_Y, TITLE_TICK_FRAME_COUNT,
...
pub use town_mode::{
    ...
    NPC_FILE_CLASS_COUNT, NPC_FILE_LEN, NPC_SCHEDULE_ARRAY_LEN, NPC_SCHEDULE_RECORD_LEN,
    NPC_SENTINEL_SLOT, NPC_WORLD_ROSTER_MAX,
