...
pub use tlk_control_codes::{
    ...
    TLK_BLOB_FIXED_WINDOW, TLK_HEADER_ENTRY_LEN, TLK_HEADER_FIXED_READ,
    TLK_INPUT_MAX_LEN, TLK_LABEL_FIRST, TLK_LABEL_LAST, TLK_SENTINEL_NPC_ID,
    TLK_TEXT_XOR_MASK, ReservedKeywordEffect, TlkByteKind, classify_tlk_byte,
    is_tlk_label_byte, reserved_keyword_effect, tlk_introducer_argument_count,
    tlk_keyword_matches,
};
