...
pub use intro::{
    ...
    parse_miscmaps_cutscene_map_file, require_miscmaps_cutscene_map,
    title_tick_flame_palette_index, title_tick_next_frame, title_tick_palette_indices,
};
pub use jimmy::{
...
pub use return_to_view::{
    ...
    RTV_STRIP_REVEAL_MIDDLE_ROW, RTV_STRIP_REVEAL_STEPS, RTV_STRIP_TILE_COUNT,
    RTV_STRIP_VISIBLE_COLUMNS, RTV_STRIP_VISIBLE_ROWS, RTV_TEMPORARY_ACTOR_TILE,
    RTV_WAIT_EXITS_ON_KEYPRESS, RTV_WAIT_FIXED_TICKS, ReturnToViewActor, ReturnToViewAssets,
    ...
    return_to_view_strip_reveal_row_visible, return_to_view_tile_for_title_tick,
    run_return_to_view_playback_until_restart, run_return_to_view_preview_state_until_restart,
    run_return_to_view_preview_until_restart, summarize_return_to_view_preview,
...
pub use stats_panel::{
    ...
    configure_play_text_windows, paint_message_text_window, paint_prompt_text_window,
