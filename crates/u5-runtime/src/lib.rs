...
pub use miscmsg_io::{
    CODEX_PRESENTATION_KEY_STEPS, MISCMSG_BLACKTHORN_AUDIENCE_PREAMBLE,
    MISCMSG_BLACKTHORN_DEMAND_RANGE, MISCMSG_BLACKTHORN_DUNGEON_THREAT,
    MISCMSG_BLACKTHORN_FIRST_WRONG_REBUKE, MISCMSG_BLACKTHORN_MERCIFUL_DEATH,
    MISCMSG_BLACKTHORN_PENDULUM_NARRATION, MISCMSG_BLACKTHORN_SAND_THREAT_PREFIX,
    MISCMSG_BLACKTHORN_TREACHERY_SPEECH, MISCMSG_BLACKTHORN_TRUTH_REWARD,
    MISCMSG_CODEX_ENTRY_NARRATION, MISCMSG_CODEX_NO_QUEST_PAGE, MISCMSG_CODEX_PAGE_OPENED,
    MISCMSG_CODEX_READS_PREFIX, MISCMSG_DAT_FILE, MISCMSG_DAT_LEN, MISCMSG_DAT_RECORDS,
    MISCMSG_SHRINE_ALTAR_ANNOUNCEMENT, MISCMSG_SHRINE_ENTRY_NARRATION,
