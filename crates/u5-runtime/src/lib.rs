...
pub use miscmsg_io::{
    ...
    MISCMSG_BLACKTHORN_TRUTH_REWARD, MISCMSG_CODEX_ENTRY_NARRATION, MISCMSG_DAT_FILE,
    MISCMSG_DAT_LEN, MISCMSG_DAT_RECORDS, MISCMSG_SHRINE_ALTAR_ANNOUNCEMENT,
    MISCMSG_SHRINE_ENTRY_NARRATION, MISCMSG_SHRINE_OFFERING_INSUFFICIENT_GOLD,
    MISCMSG_SHRINE_OFFERING_PROMPT, MISCMSG_SHRINE_QUEST_SENTENCE,
    MISCMSG_SHRINE_RETURN_INSTRUCTION, MISCMSG_SHRINE_UNFOCUSED_RESULT, MISCMSG_URN_CODEX_RANGE,
