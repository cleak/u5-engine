...
pub use story_io::{
    ...
    INTRO_START_MENU_REVEAL_RECT, INTRO_STEP_0_TRANSITION_STRIPS, INTRO_STEP_1_EXTRA_ART_X,
    ...
    INTRO_STEP_7_TRANSITION_STRIPS, INTRO_STEP_14_TRANSITION_STRIPS, INTRO_STORY_STEP_COUNT,
    INTRO_STORY6_SECONDARY_PASS_STEPS, INTRO_STORY6_SECONDARY_Y_DELTA,
    INTRO_TRANSITION_STRIP_STEPS, IntroStoryArtPlacement, RectColumnSweepTransition,
    ...
    StoryTextMarker, intro_rect_transition_revealed_columns, intro_rect_transition_tick_count,
