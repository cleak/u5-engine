...
pub fn run_play_loop(
    ...
    println!(
        "Scene {} floor/level {}. Town/world move: numpad 1-9 or lowercase wasd/yubn. Dungeon: W/S forward/back, A/D turn. Enter: e. Open: o. Push: p. Hole up: h+hours. Look: l; fountain drink lY/lN or l2Y. View: v. Use: UT/UG/UK/U1-U8. Stats: Z. Ignite: i. Talk: t or TKEYWORD. Climb: k/< />. Board/Xit/Yell sails: B/X/x/Y. Fire: f or f+dir. Cast: C opens spell-name prompt, or inline C1IL/C1AZ2/C1AN2/C1M2/C1MV2/C1CIM2/C1IS/C1RT/C1AI/C1IW/C1IMX/C1AS/C1LV/C1HR/C1IP6/C1IQW/C1AWY/C1PU/C1DP/C1AG6/C1FGI6/C1GIN6/C1GIS6/C1AEP/C1EIP/C1PRV2/C1AT. Mix: MIL/0x80/1. Order: N12. Top-down save: QY/QN. Dungeon exit prompt: QY/QN. Buffer/typeahead: buffer. Idle animation: . Optional startup wind/gear/transport/raster diagnostics: --wind, --climbing-gear, --transport, --raster-diagnostics, --raster-depth ega|cga. Pass: Space/Enter. Harness quit: q.",
        intro_target.key(),
        intro_floor
    );
