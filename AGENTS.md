...
- Engine repository: `C:\Projects\Rust\u5-engine`
- Clean asset files: `C:\Games\U5-Clean`
- Current public/specification repository: `C:\Projects\Rust\u5-spec`
...
- Use only clean-room inputs: this repository, the current public spec in
  `C:\Projects\Rust\u5-spec`, and the user's local asset files in
  `C:\Games\U5-Clean`.
