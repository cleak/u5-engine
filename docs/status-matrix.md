...
| Save/load | Known save fields, active objects, spell/reagent stock, transport markers, overlays, dungeon working buffer, mirror files, wind-driven ship movement, town floor transitions, dungeon level transitions, dungeon exit-to-world transitions, and world plane-transition overlay cache after save/load are covered. | Save/load tests in chunks 03, 07, 09, 12, 23. | Unknown byte preservation must be kept when adding new durable fields. |
