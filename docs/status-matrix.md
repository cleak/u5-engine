...
| Save/load | Known save fields, active objects, spell/reagent stock, transport markers, overlays, dungeon working buffer, mirror files, and wind-driven ship movement after save/load are covered. | Save/load tests in chunks 03, 07, 12, 23. | Unknown byte preservation must be kept when adding new durable fields. |
