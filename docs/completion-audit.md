...
| `cleak/u5-spec#59` | Overworld fall/transition and damage rules | Public chasm/falls clarifications implemented for Dex-gated fixed chasm damage and transport handling; remaining water/current families stay conservative until additional rows are published |
...
- Talk-to-shop inherited text-window selector/descriptor/cursor integration.
